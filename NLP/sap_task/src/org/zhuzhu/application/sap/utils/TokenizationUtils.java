...
public class TokenizationUtils {
  ...
  public final static List<String> LIST_STOP_WORDS_EN_MIN =
      Arrays.asList("a", "an", "and", "are", "as", "at", "be", "but", "by", "for", "if", "in",
          "into", "is", "it", "no", "not", "of", "on", "or", "such", "that", "the", "their", "then",
          "there", "these", "they", "this", "to", "was", "will", "with");

  public final static List<String> LIST_STOP_WORDS_EN = Arrays.asList("a", "a's", "able", "about",
  ...
  public static String removePunctuationSimple(String str) {
    if (str == null) {
      return "";
    }
  ...
  public static List<String> tokenizeTextEN(String text) {
    ...
    try {
      ...
      while (stream.incrementToken()) {
        if (LIST_STOP_WORDS_EN.contains(termAtt.toString())) {
          continue;
        }
